...
class Chapter3ProjectStructureTests(TestCase):
    ...
    def test_project_created(self):
        ...
        """
        directory_exists = os.path.isdir(os.path.join(self.project_base_dir, 'TWDProject'))
        urls_module_exists = os.path.isfile(os.path.join(self.project_base_dir, 'TWDProject', 'urls.py'))
...
class Chapter3IndexPageTests(TestCase):
    ...
    def setUp(self):
        ...
        self.project_urls_module = importlib.import_module('TWDProject.urls')
